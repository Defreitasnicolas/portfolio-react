  ...
  const projectsData = [
    {
      ...
      logoTechno: ["src/assets/reactjs.svg", "src/assets/sass-original.svg", "src/assets/javascript.svg", "src/assets/html.svg", "src/assets/git.svg", "src/assets/github.svg"],
      technoAlt: ["Ceci est le logo react", "Ceci est le logo sass", "Ceci est le logo js", "Ceci est le logo html", "Ceci est le logo git", "Ceci est le logo github"],
      description:
   ...
   
    {
      ...
      logoTechno: ["src/assets/reactjs.svg", "src/assets/css.svg", "src/assets/javascript.svg", "src/assets/nodejs.svg", "src/assets/mysql.svg", "src/assets/html.svg", "src/assets/git.svg", "src/assets/github.svg"],
      technoAlt: ["Ceci est le logo react", "Ceci est le logo sass", "Ceci est le logo js", "Ceci est le logo nodejs", "Ceci est le logo mysql", "Ceci est le logo html", "Ceci est le logo git", "Ceci est le logo github"],
      description:
    ...
    },
    {
      ...
      technoAlt: ["Ceci est le logo react", "Ceci est le logo sass", "Ceci est le logo js", "Ceci est le logo nodejs", "Ceci est le logo mysql", "Ceci est le logo git", "Ceci est le logo github"],
      description:
